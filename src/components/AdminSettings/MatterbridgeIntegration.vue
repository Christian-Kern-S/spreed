...
export default {
	...
	computed: {
		...
		description() {
			return t('spreed', 'You can install the Matterbridge to link Villefort Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}Nextcloud App Store{linkend}.')
